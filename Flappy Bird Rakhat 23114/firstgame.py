...
def draw_bg():
    screen.blit(bg_surface,(bg_x_pos,-200))
    screen.blit(bg_surface,(bg_x_pos +576,-200))

def create_pipe():
    random_pipe_pos = random.choice(pipe_height)
    bottom_pipe = pipe_surface.get_rect(midtop = (700,random_pipe_pos))
    top_pipe = pipe_surface.get_rect(midbottom = (700,random_pipe_pos - 280))
...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center = (288,180))
...
message_surface = pygame.transform.scale2x(pygame.image.load('assets/message.png').convert_alpha())
message_rect = game_over_surface.get_rect(center = (288,100))
...
while True:
        for event in pygame.event.get():
                        ...
                        if event.type == pygame.KEYDOWN:
                            ...
                            if event.key == pygame.K_SPACE and pre_game_active == True:
                                pre_game_active = False
                                game_active = True
                                pipe_list.clear()
